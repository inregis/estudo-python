...
class ContaPoupanca(Conta):
    ...
    def aplicar_rendimento(self):
        rendimento = self.saldo * self._taxa_rendimento
...
def recuperar_conta_cliente(cliente):
    ...
    for i, conta in enumerate(cliente.contas, start=1):
        tipo = "C/C" if isinstance(conta, ContaCorrente) else "C/P"
        print(f"[{i}] {tipo} - Agência: {conta.agencia} Conta: {conta.numero}")
...
def criar_conta(numero_conta, clientes, contas):
    ...
    print("\nTipo de conta:")
    print("[1] Conta Corrente (C/C)")
    print("[2] Conta Poupança (C/P)")
